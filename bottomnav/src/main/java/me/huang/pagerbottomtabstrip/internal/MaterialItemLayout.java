package me.huang.pagerbottomtabstrip.internal;
...
import me.huang.pagerbottomtabstrip.ItemController;
import me.huang.pagerbottomtabstrip.MaterialMode;
...
import me.huang.pagerbottomtabstrip.listener.SimpleTabItemSelectedListener;
...
public class MaterialItemLayout extends ViewGroup implements ItemController {
     ...
     */
    public void initialize(List<MaterialItemView> items, List<Integer> checkedColors, int mode, boolean animateLayoutChanges, boolean doTintIcon, int color, int textColor) {
    ...
    public void addMaterialItem(int index, Drawable defaultDrawable, Drawable selectedDrawable, String title, int selectedColor) {
        ...
        materialItemView.initialization(title, defaultDrawable, selectedDrawable, mItemTintIcon, mItemDefaultColor, mItemTextColor, mChangeBackgroundMode ? Color.WHITE : selectedColor);
