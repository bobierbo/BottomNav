package me.huang.pagerbottomtabstrip.item;
...
import me.huang.pagerbottomtabstrip.R;
...
public class MaterialItemView extends BaseTabItem {
    ...
    public MaterialItemView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mTextSmallSize = getResources().getInteger(R.integer.material_bottom_navigation_text_size_small);
        mTextBigSize = getResources().getInteger(R.integer.material_bottom_navigation_text_size_big);
    ...
    public void initialization(String title, Drawable drawable, Drawable checkedDrawable, boolean tintIcon, int color, int textColor, int checkedColor) {
        mTintIcon = tintIcon;
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mLabel.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTextSmallSize + mAnimatorValue * 2f);
            }
        });
    }
    ...
    public void setChecked(boolean checked) {
        ...
        if (mIsMeasured) {
            ...
            mLabel.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTextBigSize);
        } else { // 布局还未测量并且未选中，保持未选中状态
            mIcon.setTranslationY(0);
            mLabel.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTextSmallSize);
        }
