package me.huang.pagerbottomtabstrip;
...
import me.huang.pagerbottomtabstrip.internal.CustomItemLayout;
import me.huang.pagerbottomtabstrip.internal.CustomItemVerticalLayout;
import me.huang.pagerbottomtabstrip.internal.MaterialItemLayout;
import me.huang.pagerbottomtabstrip.internal.MaterialItemVerticalLayout;
import me.huang.pagerbottomtabstrip.internal.Utils;
import me.huang.pagerbottomtabstrip.item.BaseTabItem;
import me.huang.pagerbottomtabstrip.item.MaterialItemView;
import me.huang.pagerbottomtabstrip.item.OnlyIconMaterialItemView;
...
public class PageNavigationView extends ViewGroup {
    ...
    public class MaterialBuilder {
        ...
        public NavigationController build() {
            ...
            if (enableVerticalLayout) {//垂直布局
                ...
                for (MaterialItemViewData data : itemDatas) {
                    ...
                    materialItemView.initialization(data.title, data.drawable, data.checkedDrawable, doTintIcon, defaultColor, textColor, data.chekedColor);
                ...
                for (MaterialItemViewData data : itemDatas) {
                    ...
                    materialItemView.initialization(data.title, data.drawable, data.checkedDrawable, doTintIcon, defaultColor, textColor, changeBackground ? Color.WHITE : data.chekedColor);
                ...
                materialItemLayout.initialize(items, checkedColors, mode, animateLayoutChanges, doTintIcon, defaultColor, textColor);
        ...
        /**
         * 设置导航按钮的默认文字（未选中状态）颜色
         *
         * @param color 16进制整形表示的颜色，例如红色：0xFFFF0000
         * @return {@link MaterialBuilder}
         */
        public MaterialBuilder setTextColor(@ColorInt int color) {
            textColor = color;
            return MaterialBuilder.this;
        }
